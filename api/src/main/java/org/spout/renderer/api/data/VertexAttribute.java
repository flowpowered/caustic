...
public class VertexAttribute implements Cloneable {
    ...
    /**
     * Replaces the current buffer data with the list of bytes in the give {@link gnu.trove.list.TByteList} This method arbitrarily creates data for the ByteBuffer regardless of the data type of the vertex
     * attribute.
     *
     * @param list to set
     */
    ...
    /**
     * Replaces the current buffer data with the list of bytes in the give {@link gnu.trove.list.TShortList} This method arbitrarily creates data for the ByteBuffer regardless of the data type of the vertex
     * attribute.
     *
     * @param list to set
     */
    ...
    /**
     * Replaces the current buffer data with the list of bytes in the give {@link gnu.trove.list.TIntList} This method arbitrarily creates data for the ByteBuffer regardless of the data type of the vertex
     * attribute.
     *
     * @param list to set
     */
    ...
    /**
     * Replaces the current buffer data with the list of bytes in the give {@link gnu.trove.list.TFloatList} This method arbitrarily creates data for the ByteBuffer regardless of the data type of the vertex
     * attribute.
     *
     * @param list to set
     */
    ...
    /**
     * Replaces the current buffer data with the list of bytes in the give {@link gnu.trove.list.TDoubleList} This method arbitrarily creates data for the ByteBuffer regardless of the data type of the vertex
     * attribute.
     *
     * @param list to set
     */
