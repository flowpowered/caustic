...
public final class CausticUtil {
    ...
    /**
     * Gets the {@link java.io.InputStream}'s data as a {@link java.nio.ByteBuffer}. The image data reading is done according to the {@link org.spout.renderer.api.gl.Texture.Format}. The image size is stored in
     * the passed {@link Rectangle} instance.
     *
    ...
    /**
     * Converts a {@link org.spout.renderer.api.data.Color} to a {@link java.awt.Color}.
     *
