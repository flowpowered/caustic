...
public class Color extends Vector4f {
    ...
    /**
     * Returns the normalized version of this color. If all the component are already smaller or equal to one, the color itself is returned. Else, all the values are divided by 255 and the new
     * normalized color is returned.
     *
