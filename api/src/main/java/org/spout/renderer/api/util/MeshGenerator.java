...
public class MeshGenerator {
    ...
    /**
     * Builds the mesh information into a {@link org.spout.renderer.api.data.VertexData} which can then be uploaded and rendered. The {@code sizes} parameter is used to control which information to
