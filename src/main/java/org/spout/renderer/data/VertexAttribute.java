...
public class VertexAttribute implements Cloneable {
    ...
    /**
     * Replaces the current buffer data with the list of bytes in the give {@link TByteList} This method arbitrarily creates data for the ByteBuffer regardless of the data type of the vertex
     * attribute.
     *
     * @param list to set
     */
    ...
    /**
     * Replaces the current buffer data with the list of bytes in the give {@link TShortList} This method arbitrarily creates data for the ByteBuffer regardless of the data type of the vertex
     * attribute.
     *
     * @param list to set
     */
    ...
    /**
     * Replaces the current buffer data with the list of bytes in the give {@link TIntList} This method arbitrarily creates data for the ByteBuffer regardless of the data type of the vertex
     * attribute.
     *
     * @param list to set
     */
    ...
    /**
     * Replaces the current buffer data with the list of bytes in the give {@link TFloatList} This method arbitrarily creates data for the ByteBuffer regardless of the data type of the vertex
     * attribute.
     *
     * @param list to set
     */
