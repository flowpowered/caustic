 ...
 * and height dimensions need to be set with {@link #setFormat(org.spout.renderer.gl.Texture.Format)}, {@link #setWidth(int)} and {@link #setHeight(int)} respectively before the render buffer can be
 * created.
 */
