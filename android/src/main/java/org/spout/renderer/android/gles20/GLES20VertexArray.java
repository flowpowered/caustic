...
/**
 * An OpenGLES 2.0 implementation of {@link org.spout.renderer.api.gl.VertexArray}. <p/> Vertex arrays will be used if the ARB or APPLE extension is supported by the hardware. Else, since core OpenGL
 * doesn't support them until 3.0, the vertex attributes will have to be redefined on each render call.
 *
 * @see org.spout.renderer.api.gl.VertexArray
 */
